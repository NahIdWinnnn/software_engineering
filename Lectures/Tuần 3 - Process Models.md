...
- `Process, process model, iteration.`
- `Giới thiệu các process models.`
- `Điểm chung của các models.`
- `Đối phó với tình huống thực tế bằng các models.`

---
# *Definition:*

### Process (software process):
- `Đơn giản chỉ là quá trình tạo ra sản phẩm phần mềm.`
- `Gồm 4 bước chính:`
	...
	- `Cải tiến - Evolution.`
### Process model:
- `Process là nói chung chung ra gồm 4 bước. Phải có một số "chuẩn" rõ ràng để khoa học, để toán học hơn.`
### Iteration:
- `Mỗi lần làm ra 1 (hoặc một vài) tính năng là một lần phải cập nhật mới vào hệ thống. Mỗi bản vá, bản nâng cấp như thế phải được lên kết hoạch đầy đủ rõ ràng (4 bước chính của process).`
...
### Specification:
- `Đặc tả yêu cầu: Định nghĩa các dịch vụ và ràng buộc cho phần mềm.`
### Design and Implementation:
- `Thiết kế và cài đặt:`
	- `Thiết kế cấu trúc phần mềm.`
	- `Chuyển thiết kế thành phần mềm thực thi được.`
### Validation:
- `Chứng minh, bảo vệ hệ thống rằng nó thỏa mãn yêu cầu khách hàng.`
### Evolution:
- `Làm hệ thống thích nghi với hệ thống nghiệp vụ mới, môi trường mới.`
